...
void DataLoad_CellVolt_Test(void) {
	...
	g_stCellInfoReport.u16VCell[29] = test1;
	g_stCellInfoReport.u16VCell[30] = test2;
	g_stCellInfoReport.u16VCell[31] = test3;
...
void DataLoad_Current(void) {
	...
	//g_stCellInfoReport.u16Ichg += (g_i16CalibCoefB[MDL_ICHG]>>10);
	//g_stCellInfoReport.u16IDischg += (g_i16CalibCoefB[MDL_IDSG]>>10);
}
